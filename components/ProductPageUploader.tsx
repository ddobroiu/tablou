        ...
        <div className="relative">
            ...
            <label 
                ...
                className={`flex items-center justify-center gap-2 w-full p-3 border-2 border-dashed rounded-xl cursor-pointer transition-all
                    ${uploading ? "bg-zinc-100 border-zinc-300" : "border-emerald-200 hover:border-emerald-500 hover:bg-emerald-50/50"}`}
            >
                {uploading ? <Loader2 className="animate-spin text-emerald-600" /> : <Upload className="text-emerald-600" />}
