    ...
    return (
        <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 border-gray-200 dark:border-gray-700 shadow-sm">
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    <h3 className="text-xl font-bold text-slate-900 dark:text-white">Securitate parolă</h3>
                ...
                <div>
                    ...
                    <div className="relative">
                        <input
                            ...
                            className="w-full pl-4 pr-12 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-white dark:bg-slate-900 text-slate-900 dark:text-gray-100 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/10 transition-all duration-200"
                        ...
                        <div className="mt-2">
                            <div className="flex gap-1">
                                {[1, 2, 3, 4].map((level) => (
                                    <div
                                        key={level}
                                        className={`flex-1 h-1 rounded-full transition-colors duration-300 ${next.length >= level * 2
                                                ? next.length >= 8
                                                    ? 'bg-green-500'
                                                    : next.length >= 6
                                                        ? 'bg-yellow-500'
                            ...
                            <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
                                {next.length < 6 ? 'Prea scurtă' : next.length < 8 ? 'Acceptabilă' : 'Puternică'}
                            </p>
                        </div>
                    )}
                </div>
