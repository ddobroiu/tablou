                    ...
                    <div>
                        <header className="mb-6">
                            <div className="flex justify-between items-center gap-4 mb-3">
                                <div>
                                    <span className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Banner Vânzare / Închiriere</span>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                <div className="flex flex-col lg:flex-row lg:justify-between lg:items-center gap-2">
                                    <div className="flex flex-col">
                                        ...
                                        <p className="text-3xl font-extrabold text-gray-900">{formatMoneyDisplay(totalPrice + (designOption === 'pro' ? PRO_DESIGN_FEE : 0))}</p>
                                        {designOption === 'pro' && (
                    ...
                    <div className="p-6 lg:p-8">
                        {activeTab === 'descriere' && (
                            <>
                                ...
                                <div className="prose prose-sm prose-slate max-w-none text-base lg:text-lg text-gray-700 leading-relaxed" dangerouslySetInnerHTML={{ __html: product.description || "" }} />
                                ...
                                <div className="mt-8 grid grid-cols-1 md:grid-cols-2 gap-6 bg-slate-50 p-6 rounded-xl border border-slate-100">
                                    <div>
                                        ...
                                        <p className="text-sm text-gray-600">Banner Frontlit de înaltă rezoluție, ideal pentru promovare outdoor și indoor.</p>
                                    </div>
