...
export default function AdminOrderStatusControl({ id, status: initialStatus, onChange }: Props) {
  ...
  const getStatusColor = (s: string) => {
      switch(s) {
          ...
          case 'active': default: return 'bg-emerald-50 text-emerald-700 border-emerald-200';
      }
  };
      ...
      <div className="relative inline-block flex-1 md:flex-initial">
        <select
          ...
          className={`
            ...
            focus:outline-none focus:ring-2 focus:ring-offset-1 focus:ring-emerald-500 disabled:opacity-50 disabled:cursor-not-allowed
          `}
        >
