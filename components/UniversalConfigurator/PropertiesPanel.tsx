...
export const PropertiesPanel: React.FC<PropertiesPanelProps> = ({
    ...
    if (activeTool === 'edit-text' && el.type === 'text') {
        return (
            <div style={panelStyle} className="hide-scrollbar">
                ...
                <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                    ...
                    {/* Font Size */}
                    <div>
                        <label style={{ fontSize: '0.8rem', fontWeight: 600, display: 'block', marginBottom: '0.5rem' }}>Mărime Font Exactă: {el.fontSize}px</label>
                        <input
                            type="range"
                            min="12"
                            max="120"
                    ...
                    <div>
                        ...
                        <div style={{ maxHeight: '200px', overflowY: 'auto', border: '1px solid var(--border)', borderRadius: '8px', padding: '0.5rem' }} className="hide-scrollbar">
                            {[
                                {
                                ...
                                <div key={group.category} style={{ marginBottom: '1rem' }}>
                                    <div style={{ fontSize: '0.7rem', fontWeight: 700, color: '#64748b', marginBottom: '0.3rem', textTransform: 'uppercase' }}>{group.category}</div>
                    ...
                    <button
                        className="w-full py-2 bg-slate-100 text-slate-600 dark:text-slate-400 rounded-lg hover:bg-slate-200 transition"
