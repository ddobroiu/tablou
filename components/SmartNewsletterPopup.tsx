...
export default function SmartNewsletterPopup({
  ...
  return (
    <div className="fixed inset-0 z-[9999] pointer-events-none flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="relative pointer-events-auto max-w-md mx-4 bg-white dark:bg-slate-900 rounded-2xl shadow-2xl overflow-hidden animate-in fade-in zoom-in duration-300">
        {/* Close button */}
        <button
          onClick={handleClose}
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 text-white p-6 text-center">
          <div className="flex justify-center mb-3">
            <div className="bg-white dark:bg-slate-900/20 p-3 rounded-full">
              <Gift size={32} />
            </div>
          </div>
          <h2 className="text-2xl font-bold mb-2">
            Newsletter Tablou.net
          </h2>
