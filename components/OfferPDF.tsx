        ...
        <Document>
            <Page size="A4" style={styles.page}>
                ...
                <View style={styles.headerBg}>
                    <View>
                        <Text style={styles.headerTitle}>Tablou.net</Text>
                ...
                <View style={styles.table}>
                    ...
                    {items.map((item, i) => {
                        ...
                        pushIf('Margine', 'Margine', 'edge', 'edge_type', 'edgeType', 'Edge_type');

                        // 10) Master Configurator Keys
                        pushIf('Grosime (mm)', 'Thickness_mm', 'thickness', 'thickness_mm');
                        pushIf('Grosime Material / Greutate', 'PaperWeightKey', 'paperWeightKey');
                        pushIf('Tip Print', 'Print_type', 'print_type', 'printType');
                        pushIf('Culoare', 'Color', 'color');
                        pushIf('Ramă/Sistem', 'FrameType', 'frameType', 'frame');
                        pushIf('Distribuție Grafică', 'Artwork_distribution', 'artwork_distribution', 'artworkDistribution');
                        pushIf('Număr Fețe', 'Sides_count', 'sides_count', 'sidesCount');
                        pushIf('Tip Material', 'Material_type', 'material_type', 'materialType');
                        ...
                        // 12) Finisaje / other boolean flags
                        if (meta.want_hem_and_grommets === true || meta.Want_hem_and_grommets === true || meta.tiv === true || meta.tiv_capse === true) details.push('Finisaje: Tiv și Capse');
                ...
                <View style={styles.totals} wrap={false}>
                    ...
                    <View style={styles.grandTotal}>
                        <Text style={{ fontWeight: 'bold', fontSize: 12, color: '#16a34a' }}>TOTAL:</Text>
                        <Text style={{ fontWeight: 'bold', fontSize: 14, color: '#16a34a' }}>{formatPrice(total)}</Text>
                    </View>
                </View>
