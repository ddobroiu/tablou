...
const FAQItem = ({ question, answer, isOpen, onClick }: { question: string, answer: string, isOpen: boolean, onClick: () => void }) => {
    return (
        <div className="border-b border-slate-100 last:border-0">
            ...
            >
                <span className="text-slate-900 font-bold text-base lg:text-lg group-hover:text-emerald-600 transition-colors">
                    {question}
                </span>
                <ChevronDown
...
export default function FAQSection() {
    ...
    const faqs = [
        ...
        },
        {
            ...
            answer: "Desigur. Îți poți introduce datele firmei în pagina de checkout. Factura se emite automat prin Oblio și o primești pe email, dar o poți descărca și oricând din contul tău de client."
        }
    ];
