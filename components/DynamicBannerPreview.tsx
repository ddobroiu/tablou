...
type Props = {
  ...
  /** Textură microperforată (mesh) — separat de opțiunea „găuri de vânt” la banner PVC */
  previewVariant?: "solid" | "mesh";
  label?: string;
        ...
        >
            ...
            >
                <div className="absolute inset-0 flex flex-col items-center justify-center text-center p-2">
                    <div className="border-2 border-dashed border-zinc-300 w-full h-full flex flex-col items-center justify-center rounded opacity-60 relative overflow-hidden">
                        {previewVariant === "mesh" && (
                            <div
                        ...
                        <span className="text-zinc-400 font-bold text-[10px] sm:text-xs uppercase tracking-widest mb-1 relative z-[1]">Grafica Ta</span>
                        <div className="bg-zinc-100 text-zinc-600 px-2 py-0.5 rounded text-[9px] font-mono font-bold relative z-[1]">
