...
export default function RelatedProducts({
  ...
  return (
    <section className="w-full bg-gradient-to-br from-slate-50 via-white to-emerald-50/20 py-12 sm:py-16 border-t border-slate-200">
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">

        {/* Header - pe un singur rând */}
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-3">
            <div className="w-1 h-8 bg-gradient-to-b from-emerald-600 to-purple-600 rounded-full"></div>
        ...
        <div className="relative group">
          ...
          <button
            onClick={scrollLeft}
            className="absolute left-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white border-2 border-slate-200 text-slate-700 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 shadow-lg transition-all opacity-0 group-hover:opacity-100 -translate-x-4 group-hover:translate-x-0"
          ...
          <button
            onClick={scrollRight}
            className="absolute right-0 top-1/2 -translate-y-1/2 z-20 p-3 rounded-full bg-white border-2 border-slate-200 text-slate-700 hover:bg-emerald-600 hover:text-white hover:border-emerald-600 shadow-lg transition-all opacity-0 group-hover:opacity-100 translate-x-4 group-hover:translate-x-0"
