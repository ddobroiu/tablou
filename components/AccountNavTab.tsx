...
interface NavTabItem {
    id: "profile" | "orders" | "billing" | "addresses" | "payment-methods" | "favorites" | "security";
    label: string;
...
interface AccountNavTabProps {
    activeTab: "profile" | "orders" | "billing" | "addresses" | "payment-methods" | "favorites" | "security";
    onTabChange: (tab: "profile" | "orders" | "billing" | "addresses" | "payment-methods" | "favorites" | "security") => void;
}
    ...
    return (
        <nav className="flex flex-col gap-4 sm:gap-6 bg-white dark:bg-slate-800 p-3 lg:p-6 rounded-xl lg:rounded-3xl border-2 border-gray-200 dark:border-gray-700 shadow-lg">
            ...
            <div className="hidden lg:flex items-center gap-3 px-1 pb-2 border-b border-gray-200/50 dark:border-gray-700/50">
                <div className="w-8 h-8 bg-gradient-to-br from-emerald-500 to-purple-600 rounded-xl flex items-center justify-center">
                    <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5.121 17.804A13.937 13.937 0 0112 16c2.5 0 4.847.655 6.879 1.804M15 10a3 3 0 11-6 0 3 3 0 016 0zm6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                    </svg>
                </div>
                <div>
                    <h3 className="text-lg font-bold text-slate-900 dark:text-white">Meniul meu</h3>
