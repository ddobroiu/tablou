...
export default function Newsletter({ siteName, siteDomain }: NewsletterProps) {
  ...
  return (
    <section className="relative overflow-hidden py-16 px-4">
      {/* Background Orbs */}
      <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-64 h-64 bg-emerald-500/20 blur-[100px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-4xl mx-auto">
        <div className="relative z-10 bg-white dark:bg-slate-900/40 backdrop-blur-xl border border-white/40 shadow-2xl rounded-[2.5rem] p-8 md:p-12 overflow-hidden">
          {/* Accent Line */}
          ...
          <div className="grid md:grid-cols-5 gap-12 items-center">
            <div className="md:col-span-3">
              <div className="flex items-center gap-2 mb-4">
                <span className="px-3 py-1 bg-emerald-100 text-emerald-700 text-xs font-bold uppercase tracking-wider rounded-full flex items-center gap-1.5">
                  <Sparkles size={12} />
                  Oferte Exclusive
                </span>
              </div>
              ...
              <h2 className="text-3xl md:text-4xl font-black text-gray-900 mb-4 leading-tight">
                Newsletter <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-purple-600">{siteName}</span>
              </h2>
            ...
            <div className="md:col-span-2">
              <form onSubmit={handleSubmit} className="relative group">
                ...
                <div className="relative bg-white dark:bg-slate-900 rounded-2xl p-2 flex flex-col gap-2">
                  <div className="flex items-center px-4 py-3 bg-gray-50 rounded-xl border border-gray-100 focus-within:ring-2 focus-within:ring-emerald-500/20 transition-all">
                  ...
                  <button
                    ...
                    className="w-full bg-emerald-600 hover:bg-emerald-700 text-white font-bold py-4 rounded-xl transition-all active:scale-[0.98] disabled:opacity-50 flex items-center justify-center gap-2 shadow-lg shadow-emerald-200"
                  >
                    {status === 'loading' ? (
