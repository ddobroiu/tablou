      ...
      <Link href={href} className="block group" aria-label={`Configurează ${product.title}`}>
        <div className="relative aspect-square">
          ...
          <div className="absolute inset-x-0 bottom-0 p-4">
            <div className="rounded-xl bg-gradient-to-br from-emerald-700/90 to-fuchsia-600/90 p-px">
              <div className="rounded-[10px] bg-slate-900/80 px-4 py-3 backdrop-blur-sm flex items-center justify-between gap-3">
                <div className="min-w-0">
                  ...
                  <p className="text-emerald-200 text-sm mt-0.5">{priceDisplay}</p>
                </div>
                <span className="shrink-0 inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-gradient-to-r from-emerald-600 to-fuchsia-600 text-white text-sm font-semibold shadow-md">
                  Configurează
                </span>
              </div>
            </div>
