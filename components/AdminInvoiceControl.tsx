        ...
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
          ...
          <DialogContent className="bg-[#09090b] border-white/10 text-white">
             ...
             <div className="py-4">
                ...
                {uploading && <p className="text-xs text-emerald-400 mt-2 animate-pulse">Se încarcă...</p>}
             </div>
          </DialogContent>
        </Dialog>
      </div>
        ...
        <label 
          ...
          className={`flex items-center justify-center w-full h-7 rounded border text-[10px] font-medium cursor-pointer transition-all
            ${uploading 
              ...
              : 'bg-emerald-600/10 border-emerald-600/30 text-emerald-400 hover:bg-emerald-600 hover:text-white hover:border-emerald-500'
            }`}
        >
