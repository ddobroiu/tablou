...
export default function AccountDetailsForm() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        setLoading(true);
        try {
            // NOTE: This endpoint needs to be implemented in tablou
        ...
        <div className="bg-white dark:bg-slate-800 rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 border-gray-200 dark:border-gray-700 shadow-sm">
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        <h3 className="text-xl font-bold text-slate-900 dark:text-white">Informații personale</h3>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <div className="relative">
                            <input
                                ...
                                className={`w-full px-4 py-3 rounded-xl border-2 transition-all duration-200 bg-white dark:bg-slate-900 text-slate-900 dark:text-gray-100 ${isFocused
                    ...
                    <div>
                        ...
                        <div className="relative">
                            <div className="w-full px-4 py-3 rounded-xl border-2 border-gray-200 dark:border-gray-700 bg-slate-50 dark:bg-slate-800 text-gray-500 dark:text-gray-400">
                ...
                <div className="flex justify-end">
                    <button
                        type="submit"
                        disabled={loading}
                        className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-emerald-600 to-purple-600 hover:from-emerald-700 hover:to-purple-700 text-white rounded-xl font-semibold transition-all duration-200 shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                        {loading ? (
                            <>
