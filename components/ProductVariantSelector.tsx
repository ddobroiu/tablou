        ...
        <AnimatePresence>
            <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 sm:p-6 font-sans">
                ...
                >
                    ...
                    <div className="md:w-5/12 lg:w-1/2 relative h-48 sm:h-64 md:h-auto bg-slate-100 overflow-hidden group shrink-0">
                        <img
                            src={productImage}
                            alt={displayTitle}
                            className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-110"
                        />
                        <div className="absolute inset-0 bg-gradient-to-t from-slate-900/90 via-slate-900/40 md:via-slate-900/20 to-transparent opacity-90" />

                        <div className="absolute bottom-0 left-0 right-0 p-6 md:p-8 text-white z-10">
                            <span className="inline-flex items-center gap-1.5 px-3 py-1 mb-2 md:mb-4 text-[10px] md:text-xs font-bold tracking-widest uppercase bg-white/10 backdrop-blur-md rounded-full border border-white/20 text-emerald-300 shadow-sm transition-all duration-300">
                            ...
                            <h2 className="text-xl sm:text-2xl lg:text-3xl font-bold leading-tight drop-shadow-md mb-2 min-h-[3rem] md:min-h-[4rem] transition-all duration-300">
                                {displayTitle}
                            </h2>
                            <p className="text-slate-300 text-xs sm:text-sm font-medium line-clamp-2 opacity-90 transition-opacity duration-300">
                            ...
                            {variants.map((variant, index) => {
                                ...
                                return (
                                    <motion.button
                                        ...
                                        className="group relative flex items-center gap-5 p-4 rounded-2xl border-2 border-slate-100 hover:border-emerald-500/30 hover:shadow-xl hover:shadow-emerald-500/10 hover:-translate-y-1 transition-all duration-300 bg-white text-left w-full overflow-hidden"
                                    >
                                        ...
                                        <div className="flex-1 min-w-0">
                                            <div className="flex items-center justify-between mb-1">
                                                <span className="font-bold text-lg text-slate-900 group-hover:text-emerald-900 transition-colors truncate pr-2">
                                                    {info.name}
                                                </span>
                                            </div>
                                        ...
                                        {/* Price Badge */}
                                        <div className="shrink-0 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-slate-50 border border-slate-100 group-hover:bg-white group-hover:border-emerald-100 group-hover:text-emerald-600 transition-all shadow-sm">
                                        ...
                                        {/* <div className="absolute right-4 top-1/2 -translate-y-1/2 text-slate-300 group-hover:text-emerald-600 group-hover:translate-x-1 transition-all opacity-0 group-hover:opacity-100">
