          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 block w-full rounded-lg border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-slate-800 text-gray-900 dark:text-white focus:ring-emerald-500 focus:border-emerald-500 sm:text-sm transition-colors py-2.5"
