...
export const Header = () => {
    return (
        <div className="text-center mb-16 relative">
            ...
            <h2 className="text-4xl lg:text-5xl font-black text-slate-900 dark:text-white mb-6 tracking-tight relative inline-block">
            ...
            <div className="flex flex-col md:flex-row justify-center items-start md:items-center gap-8 md:gap-12 max-w-5xl mx-auto text-left md:text-center mt-12 bg-white/60 backdrop-blur-sm p-6 rounded-3xl border border-white/50 shadow-sm">
                <div className="flex-1 flex items-center md:flex-col md:items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-1">1. Alegi Produsul</h3>
                ...
                <div className="flex-1 flex items-center md:flex-col md:items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-1">2. Configurezi Online</h3>
                ...
                <div className="flex-1 flex items-center md:flex-col md:items-center gap-4">
                    ...
                    <div>
                        <h3 className="font-bold text-slate-900 dark:text-white text-lg mb-1">3. Livrare Rapidă</h3>
