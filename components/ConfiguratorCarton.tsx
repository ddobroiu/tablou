  ...
  return (
    <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-800">
      ...
      <div className="p-6 lg:p-8">
        {activeTab === 'descriere' && (
          <>
            <h2 className="text-2xl lg:text-3xl font-bold text-slate-900 dark:text-white mb-4">Soluții Carton Personalizate</h2>
            <p className="text-gray-700 dark:text-gray-300 mb-8 leading-relaxed">Producem ambalaje, standuri și elemente de signalistică din carton ondulat sau carton structural (fagure) reciclabil. Imprimare directă UV de înaltă calitate.</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
              <div className="flex flex-col items-center text-center p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-purple-50 border border-emerald-100">
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Carton Prespahn Rigid</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Grosime 1.5mm-3mm, rezistență structură</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-teal-50 border border-emerald-100">
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Preț Mic</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Soluție economică pentru interior, temporar</p>
              </div>
              ...
              <div className="flex flex-col items-center text-center p-4 rounded-xl bg-gradient-to-br from-amber-50 to-orange-50 border border-amber-100">
                ...
                <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Ușor de Montat</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Lipsă ușor, ideal standuri, evenimente, PLV</p>
              </div>

              <div className="flex flex-col items-center text-center p-4 rounded-xl bg-gradient-to-br from-emerald-50 to-cyan-50 border border-emerald-100">
                <div className="shrink-0 w-12 h-12 rounded-xl bg-gradient-to-br from-emerald-500 to-cyan-600 flex items-center justify-center shadow-lg mb-3">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" />
                  </svg>
                </div>
                <h3 className="text-base font-bold text-slate-900 dark:text-white mb-2">Print Full-Color</h3>
                <p className="text-sm text-gray-600 dark:text-gray-400">Calitate excelentă, finisaj mat sau lucios</p>
              </div>
            </div>
          </>
        )}
    ...
    <main className="bg-slate-50 dark:bg-slate-800 min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            <header className="mb-6">
              <div className="flex justify-between items-center gap-4 mb-3"><h1 className="text-3xl font-extrabold text-slate-900 dark:text-white">Configurator Carton</h1></div>
            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-800 px-4">
              ...
              <AccordionStep stepNumber={2} title="Material & Detalii" summary={summaryStep2} isOpen={activeStep === 2} onClick={() => setActiveStep(2)}>
                ...
                {input.material === "ondulat" && (
                  <label className="flex items-center gap-3 py-2 cursor-pointer"><input type="checkbox" className="checkbox" checked={input.printDouble} onChange={(e) => updateInput("printDouble", e.target.checked)} /><span className="text-sm font-medium text-gray-700 dark:text-gray-300">Print Față-Verso</span></label>
                )}
                ...
                <div>
                  {productImage ? (
                    ...
                    <>
                      ...
                      {input.designOption === 'upload' && (
                        <div className="space-y-3">
                          <p className="text-sm text-gray-600 dark:text-gray-400">Încarcă fișierul tău (PDF, JPG, AI).</p>
                          <label className="flex flex-col items-center justify-center w-full h-32 px-4 transition bg-white border-2 border-gray-300 border-dashed rounded-md appearance-none cursor-pointer hover:border-gray-400 focus:outline-none">
                            <span className="flex items-center space-x-2"><UploadCloud className="w-6 h-6 text-gray-600 dark:text-gray-400" /><span className="font-medium text-gray-600 dark:text-gray-400">Apasă pentru a încărca</span></span>
                            <input type="file" name="file_upload" className="hidden" onChange={e => handleArtworkFileInput(e.target.files?.[0] ?? null)} />
                          </label>
      ...
      {detailsOpen && (
        <div className="fixed inset-0 z-[9999] flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={() => setDetailsOpen(false)}>
          <div className="relative z-10 w-full max-w-2xl bg-white dark:bg-slate-900 rounded-2xl shadow-lg border border-gray-200 dark:border-slate-800 p-8 text-slate-900 dark:text-white" onClick={e => e.stopPropagation()}>
            ...
            <h3 className="text-2xl font-bold text-slate-900 dark:text-white mb-4">Detalii Carton</h3>
