...
export default async function OrderDetailsPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const address = order.shippingAddress as any; // Using shippingAddress from Shopprint schema
    const shippingAddress = address;
    const orderTotal = Number(order.totalAmount); // Using totalAmount from Shopprint schema
    ...
    const serializedItems = order.items.map(item => ({
        ...
        total: item.total ? Number(item.total) : (Number(item.price) * item.quantity),
        artworkUrl: item.artworkUrl,
        metadata: item.metadata
    }));

    return (
        <div className="min-h-screen bg-gradient-to-br from-zinc-50 via-white to-zinc-100 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950 pt-24 lg:pt-28">
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="grid lg:grid-cols-3 gap-6">
                            ...
                            <div className="bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl shadow-zinc-200/50 dark:shadow-black/50 border border-zinc-200 dark:border-zinc-800 overflow-hidden">
                                ...
                                <div className="p-6 space-y-3">
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <p className="font-semibold text-zinc-900 dark:text-white">{shippingAddress.nume || shippingAddress.nume_prenume || shippingAddress.name || 'N/A'}</p>
                    ...
                    <div className="lg:col-span-1">
                        <div className="lg:sticky lg:top-32 bg-white dark:bg-zinc-900 rounded-3xl shadow-2xl shadow-zinc-200/50 dark:shadow-black/50 border border-zinc-200 dark:border-zinc-800 overflow-hidden">
