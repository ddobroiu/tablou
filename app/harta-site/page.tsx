...
export default async function HartaSitePage() {
    ...
    const siteName = siteConfig?.name || "Magazinul Nostru";
        ...
        <main className="container py-24 min-h-screen">
            <header className="mb-16 border-b border-slate-100 pb-16">
                <h1 className="text-4xl md:text-6xl font-black text-slate-900 mb-8 leading-[1.1] tracking-tighter">
                    Harta Site <br /><span className="text-emerald-500">{siteName}</span>
                </h1>
            ...
            <div className="grid md:grid-cols-2 gap-16">
                ...
                <section>
                    ...
                    <ul className="flex flex-col gap-3">
                        ...
                        <li><Link href="/contact" className="text-emerald-600 hover:text-emerald-800 font-semibold underline underline-offset-4">Contact</Link></li>
