  ...
  return (
    <div className="space-y-6 sm:space-y-8 animate-in fade-in duration-500 slide-in-from-bottom-2">
      ...
      <div className="flex flex-col gap-3 sm:gap-2 md:flex-row md:items-center md:justify-between">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 tracking-tight">Dashboard Oferte</h1>
      ...
      <div className="grid gap-3 sm:gap-4 grid-cols-2 xl:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm hover:bg-slate-50 transition-colors group touch-manipulation">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-slate-500">Total Oferte</p>
              <h3 className="mt-1 sm:mt-2 text-xl sm:text-2xl font-bold text-slate-900">{totalOffers}</h3>
            </div>
            <div className="p-1.5 sm:p-2 rounded-lg bg-purple-500/10 text-purple-600 group-hover:bg-purple-500/20 transition-colors">
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm hover:bg-slate-50 transition-colors group touch-manipulation">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-slate-500">Valoare Totală</p>
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm hover:bg-slate-50 transition-colors group touch-manipulation">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-slate-500">În Așteptare</p>
        ...
        <div className="relative overflow-hidden rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-4 sm:p-5 shadow-sm hover:bg-slate-50 transition-colors group touch-manipulation">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-slate-500">Convertite</p>
          ...
          <div className="mt-3 sm:mt-4 flex items-center gap-2 text-xs">
            ...
            <span className="text-slate-400">Rată conversie {((totals.fulfilled / (totalOffers || 1)) * 100).toFixed(0)}%</span>
          </div>
        </div>
      </div>
