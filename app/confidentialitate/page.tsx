...
export const metadata: Metadata = {
    ...
    description: 'Află cum colectăm, utilizăm și protejăm datele tale personale conform GDPR. Tablou.net respectă intimitatea ta și asigură securitatea datelor prin măsuri...',
    keywords: ['confidențialitate', 'gdpr', 'protectia datelor', 'tablou', 'politica date'],
    alternates: {
...
export default function ConfidentialitatePage() {
    return (
        <div className="container mx-auto px-4 pb-12 pt-28 max-w-4xl text-gray-800 dark:text-gray-200">
            <h1 className="text-3xl font-bold mb-8 text-slate-900 dark:text-white">Politica de Confidențialitate GDPR</h1>

            <div className="prose dark:prose-invert max-w-none space-y-6">
                <p><strong>Actualizat la:</strong> 23.12.2025 | <strong>Versiunea:</strong> 2.1</p>
                <p><strong>Operator de date:</strong> CULOAREA DIN VIATA SA SRL, CUI: 44820819, J20/1108/2021, Sat Topliceni, Buzău, România</p>
                <p><strong>Persoana de contact DPO:</strong> contact@Tablou.net | <strong>Telefon:</strong> 0750.473.111</p>
                ...
                <section className="bg-emerald-50 dark:bg-emerald-900/20 p-4 rounded-lg border border-emerald-100 dark:border-emerald-800">
                    <h2 className="text-xl font-bold mt-2 mb-2 text-emerald-800 dark:text-emerald-300">2. Servicii AI și Profilare Automată (Art. 22 GDPR)</h2>
                    <p>
                ...
                <section>
                    ...
                    <div className="bg-orange-50 dark:bg-orange-900/30 p-4 rounded-lg border border-orange-200 dark:border-orange-800 mb-4">
                        <p className="font-semibold text-orange-800 dark:text-orange-300 mb-2">🎨 Servicii de tipărire personalizată:</p>
                        <p className="text-orange-700 dark:text-orange-400 text-sm">
                            <strong>Tablou.net</strong> oferă exclusiv <strong>produse personalizate</strong> (bannere, afișe, flyere, canvas, autocolante, etc.)
                ...
                <section className="bg-green-50 dark:bg-green-900/20 p-4 rounded-lg border border-green-200 dark:border-green-800">
                    ...
                    <div className="grid md:grid-cols-2 gap-4 mt-3">
                        ...
                        <div>
                            ...
                            <ul className="list-disc pl-5 text-sm space-y-1">
                                <li><strong>Email:</strong> contact@Tablou.net</li>
                ...
                <section className="mt-8 border-t pt-6">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-400 mt-2">
                        Pentru întrebări juridice: <a href="mailto:contact@Tablou.net" className="text-emerald-600 underline">contact@Tablou.net</a>
                    </p>
                </section>
            </div>
        </div>
