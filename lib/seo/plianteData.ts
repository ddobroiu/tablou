...
export const PLIANTE_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "pizzerie": {
    ...
    seoTitle: "Pliante Pizzerie | Meniuri Delivery",
  ...
  "restaurant": {
    ...
    seoTitle: "Pliante Restaurant & Catering | Tipar Meniuri",
  ...
  "fast-food": {
    ...
    seoTitle: "Flyere Fast Food & Shaormerie | Promotie Stradala",
  ...
  "imobiliare": {
    ...
    seoTitle: "Flyere Imobiliare | Caut Apartamente",
  ...
  "curatenie": {
    ...
    seoTitle: "Pliante Firma Curatenie | Marketing Local",
  ...
  "servicii-funerare": {
    ...
    seoTitle: "Pliante Servicii Funerare | Pompe Funebre",
  ...
  "salon": {
    ...
    seoTitle: "Pliante Salon Infrumusetare | Lista Preturi",
  ...
  "clinica": {
    ...
    seoTitle: "Pliante Clinica & Stomatologie | Brosuri Pacienti",
  ...
  "electorale": {
    ...
    seoTitle: "Flyere Electorale | Pliante Campanie",
  ...
  "evenimente": {
    ...
    seoTitle: "Flyere Evenimente & Party | Promovare Club",
  ...
  "scoala": {
    ...
    seoTitle: "Pliante Scoala & Gradinita | Oferta Educationala",
  ...
  "braserie": {
    ...
    seoTitle: "Pliante Brasserie | Meniu Bere",
  ...
  "cafenea": {
    ...
    seoTitle: "Pliante Cafenea | Meniu Deserturi",
  ...
  "gelaterie": {
    ...
    seoTitle: "Flyere Gelaterie | Inghetata Artizanala",
  ...
  "catering": {
    ...
    seoTitle: "Pliante Catering | Evenimente",
  ...
  "food-truck": {
    ...
    seoTitle: "Flyere Food Truck | Mancare Strada",
  ...
  "reparatii-auto": {
    ...
    seoTitle: "Pliante Service Auto | Reparatii",
  ...
  "it-service": {
    ...
    seoTitle: "Flyere IT Service | Programare",
  ...
  "constructii": {
    ...
    seoTitle: "Pliante Constructii | Renovari",
  ...
  "transport": {
    ...
    seoTitle: "Flyere Transport | Logistica",
  ...
  "consultanta": {
    ...
    seoTitle: "Pliante Consultanta | Finante",
  ...
  "coafura": {
    ...
    seoTitle: "Pliante Coafor | Frizerie",
  ...
  "farmacie": {
    ...
    seoTitle: "Flyere Farmacie | Produse Sanatate",
  ...
  "dentist": {
    ...
    seoTitle: "Pliante Dentist | Stomatologie",
  ...
  "optician": {
    ...
    seoTitle: "Flyere Optica | Ochelari",
  ...
  "nunta": {
    ...
    seoTitle: "Flyere Nunti | Organizatori",
  ...
  "botez": {
    ...
    seoTitle: "Pliante Botezuri | Evenimente",
  ...
  "corporate": {
    ...
    seoTitle: "Flyere Corporate | Evenimente Afaceri",
  ...
  "festival": {
    ...
    seoTitle: "Flyere Festivaluri | Concerte",
  ...
  "sport": {
    ...
    seoTitle: "Pliante Sport | Evenimente",
  ...
  "cursuri": {
    ...
    seoTitle: "Pliante Cursuri | Training",
  ...
  "universitate": {
    ...
    seoTitle: "Flyere Universitate | Admitere",
  ...
  "muzeu": {
    ...
    seoTitle: "Pliante Muzee | Cultura",
  ...
  "teatru": {
    ...
    seoTitle: "Flyere Teatru | Spectacole",
  ...
  "librarie": {
    ...
    seoTitle: "Pliante Librarie | Carte",
  ...
  "agentie-turism": {
    ...
    seoTitle: "Flyere Agentie Turism | Vacante",
  ...
  "parc": {
    ...
    seoTitle: "Pliante Parcuri | Distractie",
  ...
  "contabil": {
    ...
    seoTitle: "Flyere Contabil | Finante",
  ...
  "asigurari": {
    ...
    seoTitle: "Pliante Asigurari | Protectie",
  ...
  "fitness": {
    ...
    seoTitle: "Pliante Fitness | Sport",
