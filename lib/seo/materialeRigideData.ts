...
export const PVC_FOREX_DATA: Record<string, LandingInfo> = {
  "panou-publicitar": {
    ...
    images: ["/products/master/placi-pvc-forex-personalizat-print-uv.png"],
...
export const PLEXIGLASS_DATA: Record<string, LandingInfo> = {
  "placa-firma": {
    ...
    shortDescription: "Plăcuță sediu social, cabinet avocat/medic. Aspect de sticlă, montaj cu distanțieri.",
    seoTitle: "Placuta Firma Plexiglass | Sigla Cabinet",
  ...
  "protectie-birou": {
    ...
    shortDescription: "Panou transparent pentru recepție, ghișeu sau birouri open-space.",
    seoTitle: "Panou Protectie Plexiglass | Separator Birou",
  ...
  "litere-plexiglass": {
    ...
    shortDescription: "Litere decupate laser din plexiglass alb, negru sau colorat.",
    seoTitle: "Litere Volumetrice Plexiglass | Sigle 3D",
  ...
  "placa-firma-transparenta": {
    ...
    seoTitle: "Placa Firma Transparenta | Plexiglass Modern",
  ...
  "protectie-covid": {
    ...
    shortDescription: "Separatoare pentru ghișee și birouri.",
    seoTitle: "Panou Protectie COVID | Separator Transparent",
  ...
  "litere-illuminated": {
    ...
    shortDescription: "Litere cu iluminare interioară.",
    seoTitle: "Litere Iluminate Plexiglass | Sigle LED",
  ...
  "placa-nume": {
    ...
    shortDescription: "Plăcuțe cu nume pentru uși de birouri.",
    seoTitle: "Placa Nume Plexiglass | Identificare",
  ...
  "separator-birou": {
    ...
    shortDescription: "Panouri pentru separarea spațiilor de lucru.",
    seoTitle: "Separator Birou Transparent | Open Space",
  ...
  "litere-firma": {
    ...
    shortDescription: "Sigle din plexiglass pentru fațade.",
    seoTitle: "Litere Firma Plexiglass | Branding 3D",
  ...
  "placa-adresa": {
    ...
    shortDescription: "Plăcuțe cu adresă pentru clădiri.",
    seoTitle: "Placa Adresa Plexiglass | Identificare",
  ...
  "protectie-receptie": {
    ...
    shortDescription: "Separatoare pentru zone de primire.",
    seoTitle: "Panou Protectie Receptie | Plexiglass",
  ...
  "litere-decorative": {
    ...
    shortDescription: "Litere pentru decor interior.",
    seoTitle: "Litere Decorative Plexiglass | Arta",
  ...
  "placa-program": {
    ...
    shortDescription: "Afișaje cu program de lucru.",
    seoTitle: "Placa Program Plexiglass | Orar",
...
export const ALUCOBOND_DATA: Record<string, LandingInfo> = {
  "fatada": {
    ...
    images: ["/products/master/panouri-alucobond-dibond-compozit-aluminiu-personalizat.png"],
...
export const POLIPROPILENA_DATA: Record<string, LandingInfo> = {
  "imobiliare": {
    ...
    images: ["/products/master/placi-polipropilena-alveolara-canalit-ieftine.png"],
...
export const CARTON_DATA: Record<string, LandingInfo> = {
  "standee": {
    ...
    images: ["/products/master/panouri-carton-plume-foam-board-personalizat.png"],
