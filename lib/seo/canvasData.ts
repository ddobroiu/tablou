...
export const CANVAS_SEO_DATA: Record<string, LandingInfo> = {
  ...
  "cadou": {
    ...
    seoTitle: "Tablou Canvas Personalizat | Cadouri Foto",
    seoDescription: "Oferă emoții în dar. Tablouri canvas personalizate cu pozele tale. Calitate premium, șasiu lemn.",
    images: ["https://pub-5e0f8c0a4c03499b92d64adf2a42dd22.r2.dev/canvas/gutscheincode-für-dotcomcanvas-1.png"],
  ...
  "nunta": {
    ...
    seoTitle: "Tablou Canvas Nunta | Print Foto Pe Panza",
    seoDescription: "Păstrează vie amintirea nunții. Printează fotografia preferată pe canvas de mari dimensiuni.",
    images: ["https://pub-5e0f8c0a4c03499b92d64adf2a42dd22.r2.dev/canvas/gutscheincode-für-dotcomcanvas-1.png"], // Poți adăuga o imagine specifică gen /products/canvas/nunta.webp
  ...
  "botez": {
    ...
    seoTitle: "Tablou Canvas Botez & Bebe | Cadouri Nasi",
  ...
  "cuplu": {
    ...
    seoTitle: "Tablou Canvas Cuplu | Cadou Valentines Day",
  ...
  "living": {
    ...
    seoTitle: "Tablouri Living & Sufragerie | Decor Perete",
  ...
  "dormitor": {
    ...
    seoTitle: "Tablouri Dormitor | Canvas Relaxant",
  ...
  "bucatarie": {
    ...
    seoTitle: "Tablouri Bucatarie | Decor Perete Dining",
  ...
  "camera-copii": {
    ...
    seoTitle: "Tablouri Camera Copii | Decor Perete",
  ...
  "birou": {
    ...
    seoTitle: "Tablouri Birou & Office | Decor Corporate",
  ...
  "salon": {
    ...
    seoTitle: "Tablouri Salon Infrumusetare & Spa | Decor",
  ...
  "cabinet-medical": {
    ...
    seoTitle: "Tablouri Cabinet Medical & Sala Asteptare",
  ...
  "hotel": {
    ...
    seoTitle: "Tablouri Hotel & Horeca | Decor Camere",
  ...
  "abstract": {
    ...
    seoTitle: "Tablouri Abstracte | Arta Moderna Pe Canvas",
  ...
  "alb-negru": {
    ...
    seoTitle: "Tablouri Alb Negru | Fotografie Artistica",
  ...
  "colaj": {
    ...
    seoTitle: "Tablou Colaj Foto | Multe Poze Pe Un Canvas",
  ...
  "aniversare": {
    ...
    seoTitle: "Tablou Canvas Aniversare | Cadou Personalizat",
  ...
  "ziua-mamei": {
    ...
    seoTitle: "Tablou Canvas Ziua Mamei | Cadou Emotiv",
  ...
  "ziua-tatalui": {
    ...
    seoTitle: "Tablou Canvas Ziua Tatalui | Cadou Barbat",
  ...
  "ziua-copiilor": {
    ...
    seoTitle: "Tablou Canvas Ziua Copiilor | Decor Copii",
  ...
  "valentine": {
    ...
    seoTitle: "Tablou Canvas Valentine | Cadou Romantic",
  ...
  "martisor": {
    ...
    seoTitle: "Tablou Canvas Martisor | Traditie Romana",
  ...
  "paste": {
    ...
    seoTitle: "Tablou Canvas Paste | Sarbatoare Crestina",
  ...
  "craciun": {
    ...
    seoTitle: "Tablou Canvas Craciun | Decor Festiv",
  ...
  "revelion": {
    ...
    seoTitle: "Tablou Canvas Revelion | An Nou Fericit",
  ...
  "hol": {
    ...
    seoTitle: "Tablouri Canvas Hol | Decor Intrare",
  ...
  "baie": {
    ...
    seoTitle: "Tablouri Canvas Baie | Decor Rezistent",
  ...
  "balcon": {
    ...
    seoTitle: "Tablouri Canvas Balcon | Decor Exterior",
  ...
  "gradina": {
    ...
    seoTitle: "Tablouri Canvas Gradina | Decor Exterior",
  ...
  "restaurant": {
    ...
    seoTitle: "Tablouri Canvas Restaurant | Decor Horeca",
  ...
  "cafenea": {
    ...
    seoTitle: "Tablouri Canvas Cafenea | Decor Relaxant",
  ...
  "bar": {
    ...
    seoTitle: "Tablouri Canvas Bar | Decor Vesel",
  ...
  "receptie-hotel": {
    ...
    seoTitle: "Tablouri Canvas Receptie Hotel | Decor Primitor",
  ...
  "camera-hotel": {
    ...
    seoTitle: "Tablouri Canvas Camera Hotel | Decor Confortabil",
  ...
  "spital": {
    ...
    seoTitle: "Tablouri Canvas Spital | Decor Medical",
  ...
  "scoala": {
    ...
    seoTitle: "Tablouri Canvas Scoala | Decor Educational",
  ...
  "universitate": {
    ...
    seoTitle: "Tablouri Canvas Universitate | Decor Academic",
  ...
  "peisaj": {
    ...
    seoTitle: "Tablouri Canvas Peisaj | Natura Pe Perete",
  ...
  "oras": {
    ...
    seoTitle: "Tablouri Canvas Oras | Arhitectura Urbana",
  ...
  "animale": {
    ...
    seoTitle: "Tablouri Canvas Animale | Prieteni Patrupede",
  ...
  "flori": {
    ...
    seoTitle: "Tablouri Canvas Flori | Aranjamente Florale",
  ...
  "mare": {
    ...
    seoTitle: "Tablouri Canvas Mare | Relaxare Acvatica",
  ...
  "munte": {
    ...
    seoTitle: "Tablouri Canvas Munte | Aventura Montana",
  ...
  "minimalist": {
    ...
    seoTitle: "Tablouri Canvas Minimaliste | Design Simplu",
  ...
  "pop-art": {
    ...
    seoTitle: "Tablouri Canvas Pop Art | Arta Moderna",
  ...
  "retro": {
    ...
    seoTitle: "Tablouri Canvas Retro | Nostalgie",
  ...
  "fantasy": {
    ...
    seoTitle: "Tablouri Canvas Fantasy | Lumi Imaginare",
  ...
  "fotbal": {
    ...
    seoTitle: "Tablouri Canvas Fotbal | Pasiune Sportiva",
  ...
  "tenis": {
    ...
    seoTitle: "Tablouri Canvas Tenis | Sport Elegant",
  ...
  "baschet": {
    ...
    seoTitle: "Tablouri Canvas Baschet | Sport Dinamic",
  ...
  "fitness": {
    ...
    seoTitle: "Tablouri Canvas Fitness | Sanatate si Miscare",
  ...
  "yoga": {
    ...
    seoTitle: "Tablouri Canvas Yoga | Echilibru Spiritual",
  ...
  "jazz": {
    ...
    seoTitle: "Tablouri Canvas Jazz | Muzica Improvizata",
  ...
  "rock": {
    ...
    seoTitle: "Tablouri Canvas Rock | Muzica Rebelă",
  ...
  "pop": {
    ...
    seoTitle: "Tablouri Canvas Pop | Muzica Populara",
  ...
  "folk": {
    ...
    seoTitle: "Tablouri Canvas Folk | Traditie Romana",
  ...
  "opera": {
    ...
    seoTitle: "Tablouri Canvas Opera | Arta Lirica",
  ...
  "balet": {
    ...
    seoTitle: "Tablouri Canvas Balet | Dans Artistic",
  ...
  "meditatie": {
    ...
    seoTitle: "Tablouri Canvas Meditatie | Pace Spirituala",
  ...
  "sanatate": {
    ...
    seoTitle: "Tablouri Canvas Sanatate | Vitalitate",
  ...
  "ecologie": {
    ...
    seoTitle: "Tablouri Canvas Ecologie | Protectia Mediului",
  ...
  "padure": {
    ...
    seoTitle: "Tablouri Canvas Padure | Natura Salbatica",
  ...
  "tech": {
    ...
    seoTitle: "Tablouri Canvas Tech | Inovatie Digitala",
  ...
  "spatiu": {
    ...
    seoTitle: "Tablouri Canvas Spatiu | Explorare Cosmica",
  ...
  "motivatii": {
    ...
    seoTitle: "Tablouri Canvas Motivatii | Citat Inspirational",
  ...
  "familie": {
    ...
    seoTitle: "Tablouri Canvas Familie | Amintiri Dragute",
  ...
  "prieteni": {
    ...
    seoTitle: "Tablouri Canvas Prieteni | Legaturi Sociale",
  ...
  "calatorii": {
    ...
    seoTitle: "Tablouri Canvas Calatorii | Aventura Globala",
  ...
  "culori": {
    ...
    seoTitle: "Tablouri Canvas Culori | Arta Abstracta",
  ...
  "lumini": {
    ...
    seoTitle: "Tablouri Canvas Lumini | Efecte Magice",
