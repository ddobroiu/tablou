...
const BRAND_VOICES: Record<BrandKey, BrandVoice> = {
  shopprint: {
    ...
    deliveryClosers: {
      apropiat: "Fiind aproape de hub-ul nostru de producție, livrarea în {localitate} durează de regulă 2-4 zile lucrătoare.",
      mediu: "Livrarea către {localitate} durează în medie 2-4 zile lucrătoare prin curier.",
      distant: "Chiar dacă {localitate} e mai departe de hub-ul nostru, livrarea prin curier ajunge de regulă în 2-4 zile lucrătoare.",
    },
    descPrefix: "Comandă",
  },
  adbanner: {
    ...
    deliveryClosers: {
      ...
      mediu: "Livrare prin curier în {localitate} în 2-4 zile lucrătoare, ca să nu pierzi timp de business.",
      distant: "Deși {localitate} e mai departe, ne organizăm să livrăm rapid, de regulă în 2-4 zile lucrătoare.",
    },
  ...
  euprint: {
    ...
    deliveryClosers: {
      apropiat: "Livrare rapidă în {localitate}, de regulă în 2-4 zile lucrătoare.",
      mediu: "Livrăm în {localitate} în 2-4 zile lucrătoare prin curier.",
      distant: "Livrăm și în {localitate}, de regulă în 2-4 zile lucrătoare prin curier.",
    },
  ...
  prynt: {
    ...
    deliveryClosers: {
      apropiat: "Livrăm în {localitate} de regulă în 2-4 zile lucrătoare, perfect pentru cadouri de ultim moment.",
      mediu: "Livrare în {localitate} în 2-4 zile lucrătoare prin curier.",
      distant: "Livrăm și în {localitate}, de regulă în 2-4 zile lucrătoare prin curier.",
    },
  ...
  tablou: {
    ...
    deliveryClosers: {
      apropiat: "Livrăm în {localitate} de regulă în 2-4 zile lucrătoare, perfect pentru un cadou de suflet pregătit din timp.",
      mediu: "Livrare în {localitate} în 2-4 zile lucrătoare prin curier, ambalat cu grijă.",
      distant: "Livrăm și în {localitate}, de regulă în 2-4 zile lucrătoare prin curier, ambalat cu grijă.",
    },
