...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
  <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 30px 20px; text-align: center; border-radius: 10px 10px 0 0;">
    <h1 style="margin: 0; font-size: 28px;">📄 Oferta ta Tablou.net</h1>
  ...
  <div style="background: #f9f9f9; padding: 30px 20px; border-radius: 0 0 10px 10px;">
    ...
    <div style="margin-top: 30px; padding-top: 20px; border-top: 2px solid #eee; text-align: center; color: #999; font-size: 13px;">
      ...
      <p style="margin: 5px 0;">📧 <strong>Email:</strong> contact@tablou.net</p>
      <p style="margin: 5px 0;">🌐 <strong>Website:</strong> <a href="https://www.tablou.net" style="color: #667eea; text-decoration: none;">www.tablou.net</a></p>
      <p style="margin: 20px 0 5px 0; font-size: 12px; color: #bbb;">
        Acest email a fost generat automat de asistentul AI Tablou.net
      </p>
    </div>
  </div>
</body>
...
Echipa Tablou.net
  ...
  const result = await resend.emails.send({
    from: 'Tablou.net <contact@tablou.net>',
    to,
    subject: `📄 Oferta ta Tablou.net #${orderNo} (${total.toFixed(2)} RON)`,
    html: htmlContent,
    text: textContent,
  });
