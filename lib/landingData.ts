...
import { BANNERE_JUDETE_DATA } from "./seo/bannereJudeteData";
...
import { EXTRA_SEO_CAMPAIGN_DATA } from "./seo/extraCampaignData";
import { STICKERE_EXTRA_DATA } from "./seo/stickereExtraData";
import { TEXTILE_EXTRA_DATA } from "./seo/textileExtraData";
...
export const LANDING_CATALOG: LandingCatalog = {
  ...
  // Bannere
  "bannere": { ...BANNER_SEO_DATA, ...EXTRA_SEO_CAMPAIGN_DATA, ...BANNERE_JUDETE_DATA } as unknown as LandingCatalog[string],
  "banner-verso": BANNER_VERSO_DATA as unknown as LandingCatalog[string],

  // Afise, Autocolante, Tapet
  "afise": AFISE_SEO_DATA as unknown as LandingCatalog[string],
  "autocolante": { ...AUTOCOLANTE_SEO_DATA, ...STICKERE_EXTRA_DATA } as unknown as LandingCatalog[string],
  "tapet": TAPET_SEO_DATA as unknown as LandingCatalog[string],

  // Categoriile principale de textile
  "tricouri": TEXTILE_EXTRA_DATA as unknown as LandingCatalog[string],
  "hanorace": TEXTILE_EXTRA_DATA as unknown as LandingCatalog[string],
  "sepci": TEXTILE_EXTRA_DATA as unknown as LandingCatalog[string],
