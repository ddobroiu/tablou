    ...
    return [
      {
        ...
        headers: [
          ...
          },
          {
            ...
            value: "default-src 'self'; script-src 'self' https://www.shopprint.ro 'unsafe-inline' 'unsafe-eval' ajax.googleapis.com *.google-analytics.com *.googletagmanager.com *.googleadservices.com *.googlesyndication.com *.doubleclick.net connect.facebook.net; style-src 'self' 'unsafe-inline' fonts.googleapis.com; img-src 'self' blob: data: cdn.pixabay.com pixabay.com res.cloudinary.com images.unsplash.com poze.tablou.net *.r2.dev shop.printcenter.ro www.printcenter.ro dotcomcanvas.de *.hotnews.ro hotnews.ro *.replicate.delivery replicate.delivery pbxt.replicate.delivery *.google-analytics.com *.googletagmanager.com *.googlesyndication.com *.googleadservices.com *.doubleclick.net *.google.com *.google.ro *.facebook.com; font-src 'self' fonts.gstatic.com; connect-src 'self' https://www.shopprint.ro blob: data: fonts.googleapis.com fonts.gstatic.com *.google-analytics.com *.googletagmanager.com *.analytics.google.com *.googlesyndication.com *.googleadservices.com *.doubleclick.net *.google.com *.google.ro *.facebook.com connect.facebook.net; frame-src 'self' https://www.youtube.com https://www.youtube-nocookie.com *.doubleclick.net *.google.com *.facebook.com;",
          },
          {
